  ...
  return (
    <section id="contact" className="relative py-20 md:py-28 overflow-hidden bottom-24">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute top-0 left-0 w-64 h-64 bg-amber-900/10 rounded-full blur-3xl transform -translate-x-1/2 -translate-y-1/2"></div>
        <div className="absolute bottom-0 right-0 w-80 h-80 bg-amber-900/10 rounded-full blur-3xl transform translate-x-1/3 translate-y-1/3"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          {/* Contact Information */}
          <div className="bg-gradient-to-br from-amber-900/30 to-black/30 backdrop-blur-sm rounded-2xl p-8 md:p-12 border border-amber-800/30 shadow-xl">
            <div className="mb-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start">
                <div className="bg-amber-900/50 p-3 rounded-lg mr-4">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-amber-300 mb-1">Email</h4>
                  <a 
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-amber-300 mb-1">Phone</h4>
                  <a 
              ...
              <div className="flex items-start">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-amber-300 mb-1">WhatsApp</h4>
          ...
          <div className="flex justify-center">
            <div className="relative">
              ...
              {/* Decorative elements */}
              <div className="absolute -bottom-6 -left-6 w-32 h-32 bg-amber-400/10 rounded-full z-0"></div>
              <div className="absolute -top-6 -right-6 w-40 h-40 bg-amber-400/10 rounded-full z-0"></div>
              
              {/* Glow effect */}
              <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full h-64 bg-amber-400/20 rounded-full blur-2xl z-0"></div>
            </div>
          </div>
        </div>
      </div>
